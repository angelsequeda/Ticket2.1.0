...
module.exports.updateCompanyEmployeeService = async(data) => {
    ...
    try {
        ...
        await companyModel.update({ profilePhoto: data.profilePhoto, name: data.name, companyName: data.companyName,   mail: data.mail,job: data.job},{where: {idCompanyUser:data.idCompanyUser}});
