...
const { areTheyFriendsForComment, areTheyFriendsForRequest, canYouMakeAcomment, itsMeForfriendship, itsMeForComment } = require('../middlewares/friendship&comments.middlewares');
